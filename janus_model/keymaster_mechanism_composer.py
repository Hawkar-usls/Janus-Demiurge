...
def load_autonomous_forge(path: Path | None) -> dict | None:
    ...
    return {
        ...
        "deferred_candidate_count": int(obj.get("deferred_candidate_count") or 0),
        "mathematically_falsified_candidate_count": int(obj.get("mathematically_falsified_candidate_count") or 0),
        "last_candidate_attack": obj.get("last_candidate_attack"),
